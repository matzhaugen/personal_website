...
\begin{itemize}
  \item \textbf{Senior Quantitative Engineer/Head of Portfolio Optimization: Mar 2021-Current, Vise AI Advisors, LLC, Remote, San Francisco, USA. }
  \begin{enumerate}
       \item[--] Chief architect for the core portfolio optimizer which manages all the $\sim$10000 accounts in a tax-aware manner currently with $\sim$\$ 10 billion USD in assets under management, up from 100 Million USD when I joined the company. 
