...
<Figure src="/covid-mortality/statewide_flu_excess_grid" n="3" alt="Excess mortality by state, grid of panels">
...
<Figure src="/covid-mortality/statewide_nonflu_excess_grid" n="4" alt="Excess mortality by state, grid of panels">
...
<Figure src="/covid-mortality/statewide_excess_by_state" n="5" alt="Excess deaths by state, ranked bar charts">
...
<Figure src="/covid-mortality/europe_excess_grid" n="6" alt="Excess mortality by European country, grid of panels">
...
<VideoFigure src="/covid-mortality/europe_excess_map" n="7" loop fps={209 / 20}>
  <i>Excess mortality across Europe, week by week. Countries in grey have no data in the Human Mortality Database.</i>
</VideoFigure>

<Figure src="/covid-mortality/europe_excess_ranked" n="8" alt="Excess deaths by European country, ranked bar charts">
...
<Figure src="/covid-mortality/europe_covid_grid" n="9" alt="Reported COVID-19 deaths by European country, grid of panels">
  <i>Reported COVID-19 deaths per 100k population, on the same country layout as Figure 6.</i>
</Figure>

<VideoFigure src="/covid-mortality/europe_covid_map" n="10" loop fps={201 / 20}>
  <i>Reported COVID-19 deaths per 100k across Europe, week by week.</i>
</VideoFigure>

<Figure src="/covid-mortality/europe_compare_countries" n="11" alt="Excess deaths versus reported COVID deaths per European country">
...
<VideoFigure src="/covid-mortality/world_covid_per100k_map" n="12" loop fps={201 / 20}>
...
<Figure src="/covid-mortality/world_covid_countries" n="13" alt="Weekly reported COVID-19 deaths for the 20 worst-affected countries">
...
<Figure src="/covid-mortality/world_covid_ranked" n="14" alt="Reported COVID-19 deaths by country, ranked two ways">
